...
![Command Prompt Ping](assets/ping.png)
...
| **Rata-rata RTT** | **73 ms** | Performa transmisi sangat baik untuk kategori interkoneksi antar-negara. |
| **Minimum RTT** | **58 ms** | Waktu tempuh tercepat paket bolak-balik ke server Hong Kong. |
| **Maximum RTT** | **104 ms** | Waktu tempuh terlama paket bolak-balik ke server Hong Kong. |
| **TTL (*Time to Live*)** | **42** | Estimasi melewati **85 router/hops** di sepanjang jalur global (Asumsi nilai awal TTL = 128). |
...
![Wireshark ICMP Ping](assets/wireping.png)
...
![ICMP Echo Reply Detail](assets/reply.png)
...
| :--- | :--- | :--- |
| **Total Lompatan (*Hops*)** | **14 hops** | Paket data melewati 11 perangkat perantara sebelum tiba di host tujuan akhir. |
...
- **Original IP Header**: Src: 192.168.1.3, Dst: 128.93.162.83
- **Original TTL**: **1** (ini sebabnya TTL exceeded)
- **Original Protocol**: ICMP (1)
- **Original ICMP**: Echo (ping) request dengan seq=63
...
- Hop yang berhasil: **192.168.1.1**, **10.122.0.1**
